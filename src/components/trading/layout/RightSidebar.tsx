...
export function RightSidebar() {
  ...
  return (
    <div className="flex flex-row h-full">
      ...
      <div
        className="w-3 cursor-col-resize self-stretch flex-shrink-0 group z-10"
        {...handleProps}
      >
        <div className="absolute inset-y-0 left-1/2 w-px -translate-x-1/2 bg-transparent group-hover:bg-tv-border transition-colors" />
      </div>
      <aside
        className="flex flex-col border-l border-tv-border bg-tv-panel flex-shrink-0 relative"
        style={{ width }}
      >
